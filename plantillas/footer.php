<!-- Footer -->
<footer class="page-footer font-small pt-5 background-home">
    ...
    <div class="container text-center text-md-left pb-4">
        ...
        <div class="row">
            ...
            <!-- Grid column -->
            <div class="col-lg-4 col-md-12 mt-md-0 mt-3">

                <div class="row pt-3">
                    <div class="col-lg-6 col-md-12">
                        <div class="text-center pb-5"><img src="<?php echo RUTA_IMG?>/inicio/eyt.png"
                                class="img-fluid" /></div>
                    </div>
                    <div class="col-lg-6 col-md-12">
            ...
            <div class="col-lg-3 col-md-12 mb-md-0 mb-3">
                ...
                <div class="ml-0 ml-md-0 ml-lg-3 pt-3">
                    ...
                    <div class="text-left text-md-left">
                        ...
                        <a class="mx-3" href="#">
                            <img src="<?php echo RUTA_IMG?>/inicio/yt_n.png" class="img-fluid" />
                        </a>
                    </div>

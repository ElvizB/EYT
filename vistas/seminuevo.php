                ...
                <div class="col-md-12">
                    <section class="p-4 p-md-5">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 filter Deportivos mb-5">
                                <div class="card rounded-2 expand" style="margin-top: 0%;">
                                    <div class="card-body rounded-2">
                                        <div class="text-center">
                                            <button type="button" class="reset-btn-semi" data-toggle="modal"
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 filter Hibridos mb-5">
                                <div class="card rounded-2 expand" style="margin-top: 0%;">
                                    <div class="card-body rounded-2">
                                        <div class="text-center">
                                            <button type="button" class="reset-btn-semi" data-toggle="modal"
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 filter Comerciales mb-5">
                                <div class="card rounded-2 expand" style="margin-top: 0%;">
                                    <div class="card-body rounded-2">
                                        <div class="text-center">
                                            <button type="button" class="reset-btn-semi" data-toggle="modal"
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 filter Familiares mb-5">
                                <div class="card rounded-2 expand" style="margin-top: 0%;">
                                    <div class="card-body rounded-2">
                                        <div class="text-center">
                                            <button type="button" class="reset-btn-semi" data-toggle="modal"
